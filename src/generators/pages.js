    ...
    if(page.url === '/') {
      const lastUpdate = `
        <div class="info_badge margin">
          🎉 Get development news in the <a href="/blog/">blog</a> (last update ${moment(data.blog[0].date).format('MMMM Do YYYY')}) and <a href="http://eepurl.com/dA9LcH" target="_blank">newsletter</a>.
        </div>
      `;
